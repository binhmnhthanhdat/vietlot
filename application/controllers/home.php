...
//            
	...
	//	$data = array();
      ...
      //  $giaidangquay = $this->category->get_category_where(array('trangthai'=>0,'reatime'=>1), array('ngayquayint' => 'desc'), array('max'=> 1, 'begin' => 0));
       ...
       //     echo "<pre>";
//            print_r($array_sotrungthuong_json);
//            echo "</pre>";
//            exit;
