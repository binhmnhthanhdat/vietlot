                    ...
                    <tbody>
                       <tr>
                          ...
                          <td class="result-max4d red">
                             <b class="livemax_nhat"><?php if($kqgiaisoxomax_dangquay->giainhat!=0){ echo $kqgiaisoxomax_dangquay->giainhat; } else {?>
                           <img src='<?php echo base_url();?>asset/images/loading.gif' width='30'> 
                           <?php } ?>   </b>
                          </td>
                       ...
                       <tr>
                          ...
                          <td class="result-max4d">
                             <b  class="livemax_nhi1"><?php if($kqgiaisoxomax_dangquay->giainhi1!=0) { echo $kqgiaisoxomax_dangquay->giainhi1; } else {?>
                           <img src='<?php echo base_url();?>asset/images/loading.gif' width='30'> 
                           <?php } ?></b>
                             <b  class="livemax_nhi2"><?php if($kqgiaisoxomax_dangquay->giainhi2!=0) { echo $kqgiaisoxomax_dangquay->giainhi2; } else { ?>
                           <img src='<?php echo base_url();?>asset/images/loading.gif' width='30'> 
                           <?php } ?></b>
                          </td>
                       ...
                       <tr>
                          ...
                          <td class="result-max4d">
                             <b  class="livemax_ba1"><?php if($kqgiaisoxomax_dangquay->giaiba1!=0) { echo $kqgiaisoxomax_dangquay->giaiba1; } else { ?>
                           <img src='<?php echo base_url();?>asset/images/loading.gif' width='30'> 
                           <?php } ?></b>
                             <b  class="livemax_ba2"><?php if($kqgiaisoxomax_dangquay->giaiba2!=0) { echo $kqgiaisoxomax_dangquay->giaiba2; } else { ?>
                           <img src='<?php echo base_url();?>asset/images/loading.gif' width='30'> 
                           <?php } ?></b>
                             <b  class="livemax_ba3"><?php if($kqgiaisoxomax_dangquay->giaiba3!=0) { echo $kqgiaisoxomax_dangquay->giaiba3; } else { ?>
                           <img src='<?php echo base_url();?>asset/images/loading.gif' width='30'> 
                           <?php } ?></b>
                          </td>
                       ...
                       <tr>
                          ...
                          <td class="result-max4d ali-center">
                             <b  class="livemax_kk1"><?php if($kqgiaisoxomax_dangquay->giainhat!=0) { echo "x".substr($kqgiaisoxomax_dangquay->giainhat,1,3); } else { ?>
                           <img src='<?php echo base_url();?>asset/images/loading.gif' width='30'> 
                           <?php } ?></b>
                          </td>
                       ...
                       <tr>
                          ...
                          <td class="result-max4d ali-center">
                             <b  class="livemax_kk2"><?php if($kqgiaisoxomax_dangquay->giainhat!=0) { echo "xx".substr($kqgiaisoxomax_dangquay->giainhat,2,2); } else { ?>
                           <img src='<?php echo base_url();?>asset/images/loading.gif' width='30'> 
                           <?php } ?></b>
                          </td>
    ...
    <div class="tab-content">
      ...
      if($giaimoinhatsoxomax->num_rows()>0)
       ...
       <div id="t_max4d" class="tab-pane fade">
          ...
          <h3 class="red text-center">Kết quả xổ số Vietlott Max 4D</h3>
          <p class="time-result title-mega645 text-center"> <?php //echo $kqgiaimoinhat->ngayquay;
